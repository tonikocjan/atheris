...
\begin{tabular}{l|l|l}
  ...
  {\bf SP} & stack pointer & kazalec na sklad \\
...
\begin{axis}[
ybar,
symbolic x coords={JUMP, TEMP, NAME, CALL, CONST, BINOP, MEM, CJUMP, MOVE, LABEL},
xtick=data,
width=420,
ylabel={$*10^6$},
]
\addplot[x=interval,y=carT,fill=blue] coordinates {
	(JUMP,   32.7)
	(TEMP,  164.8)
	(NAME,  1.4)
	(CALL,  0.1)
...
\addplot[x=interval,y=carD,fill=red] coordinates {
	(JUMP,  31.4)
	(TEMP,  136.4)
	(NAME,  1.7)
	(CALL,  0.1)
...
Izkaže se, da PINS izvede 212.498.982 (212 * $10^6$) ukazev več kot Atheris.
