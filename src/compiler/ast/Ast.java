...
public class Ast implements ASTVisitor {
	...
	public void visit(AbsAtomConstExpr atomConst) {
		...
		case DOB:
            ...
            break;
		default:
			Report.error("Internal error :: compiler.ast.Abstr.visit(AbsAtomConst)");
		}
	}
	...
	public void visit(AbsAtomType atomType) {
		...
		case VOID:
			...
			break;
		default:
			Report.error("Internal error :: compiler.ast.Abstr.visit(AbsAtomType)");
		}
	}
	...
	public void visit(AbsUnExpr unExpr) {
		...
		case AbsUnExpr.VAL:
			...
			break;
		default:
			Report.error("Internal error :: compiler.ast.Abstr.visit(AbsUnExpr)");
		}
		indent += 2;
